...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "乛𝙄𝙉𝘾𝙍𝙄𝘾𝙄𝘽𝙇𝙀🕊️⃝🦋⁪⁬𝙈𝙐𝙎𝙄𝘾")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/mrtosumemon/GODFATHERMUSIC",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/754d8f11fe2e14c0b6089.jpg "
)
